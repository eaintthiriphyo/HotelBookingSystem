        ...
        <nav id="sidebarMenu" class="collapse d-lg-block sidebar collapse bg-white">
            <div class="position-sticky">
                <div class="list-group list-group-flush mx-3 mt-4">
                    ...
                    <a href="{{route('admin.roomType.index')}}" class="list-group-item list-group-item-action py-2   {{request()->routeIs('admin.roomType.*') ? 'bg-primary text-white' : ''}}" data-mdb-ripple-init>
                    ...
                    <a href="{{route('admin.staff.index')}}" class="list-group-item list-group-item-action py-2  {{request()->routeIs('admin.staff.*') ? 'bg-primary text-white' : ''}}" data-mdb-ripple-init><i
                            class="fas fa-chart-bar fa-fw me-3"></i><span>Staff Management</span></a>
                        ...
                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdownMenuLink">
                            ...
                            <li class="card p-3 text-center">
                                <img src="https://mdbootstrap.com/img/Photos/Avatars/img (31).jpg"
                                    class="rounded-circle mb-2 d-block mx-auto" width="50">
