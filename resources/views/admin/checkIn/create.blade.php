    ...
    <script>
        $(document).ready(function() {
            ...
            $('#checkEmailBtn').click(function() {
                ...
                $.get("{{ route('admin.checkin.checkUser') }}", {
                    email: email
                }, function(data) {
                    if (data.user) {
                        $('#quickBookingForm').show();
                        ...
                        $('#emailStatus').html(
                            '<span class="text-success">Existing user! Choose dates and available rooms.</span>'
                            );
                        ...
                        $('#formPhone').val('');
                        $('#emailStatus').html(
                            '<span class="text-danger">New user! Fill details to create and book.</span>'
                            );
                    ...
                    if (checkIn && checkOut) {
                        ...
                        $.get("{{ route('admin.booking.availableRooms') }}", {
                            ...
                            data.rooms.forEach(function(room) {
                                options += '<option value="' + room.id + '">' + room
                                    .room_number + ' (' + room.room_type + ')</option>';
                            });
