                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="tel" name="address" id="address" class="form-control"
                                            value="{{ old('address') }}" placeholder="Enter address Number">
                                        @error('address')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" name="credential" id="credential" class="form-control"
                                            value="{{ old('credential') }}" placeholder="Enter NRC No /Passport No">
                                        @error('credential')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select name="department_id" class="form-control">
                                            <option value="">Select Departmetn Type</option>
                                            @foreach ($department as $type)
                                                <option value="{{ $type->id }}"
                                                    {{ old('department_id') == $type->id ? 'selected' : '' }}>
                                                    {{ $type->title }}
                                                </option>
                                            @endforeach
                                        </select>
